        ...
        private async void InitReportPage()
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(todayAchievement))
                {
                    ...
                    reportInfo1.receivableNum = jObject["Achievement"][0]["ys"].ToString();
                    reportInfo1.paidNum = jObject["Achievement"][0]["ss"].ToString();
                    reportInfo1.nrNum = (double.Parse(reportInfo1.receivableNum) - double.Parse(reportInfo1.paidNum)).ToString();
                    reportInfo1.companyRank = jObject["Achievement"][0]["rk"].ToString();
                }

                if (!string.IsNullOrWhiteSpace(todayWorkLoad))
                {
                    JObject jObject = JObject.Parse(todayWorkLoad);
                    reportInfo1.ffzs = jObject["Workload"][0]["ffzs"].ToString();
                    reportInfo1.kkzs = jObject["Workload"][0]["kkzs"].ToString();
                    reportInfo1.fgj = jObject["Workload"][0]["fgj"].ToString();
                    reportInfo1.kgj = jObject["Workload"][0]["kgj"].ToString();
                    reportInfo1.ffcs3 = jObject["Workload"][0]["ffcs3"].ToString();
                    reportInfo1.ffcs4 = jObject["Workload"][0]["ffcs4"].ToString();
                    reportInfo1.ffcs = jObject["Workload"][0]["ffcs"].ToString();
                    reportInfo1.ffcs2 = jObject["Workload"][0]["ffcs2"].ToString();
                }

                if (!string.IsNullOrWhiteSpace(todayWorkLoadRank))
                {
                    JObject jObject = JObject.Parse(todayWorkLoadRank);
                    reportInfo1.companyRank2 = jObject["WorkloadRank"][0]["RowNum"].ToString();
                }

                if (!string.IsNullOrWhiteSpace(weekAchievement))
                {
                    JObject jObject = JObject.Parse(todayAchievement);
                    reportInfo2.receivableNum = jObject["Achievement"][0]["ys"].ToString();
                    reportInfo2.paidNum = jObject["Achievement"][0]["ss"].ToString();
                    reportInfo2.nrNum = (double.Parse(reportInfo2.receivableNum) - double.Parse(reportInfo2.paidNum)).ToString();
                    reportInfo2.companyRank = jObject["Achievement"][0]["rk"].ToString();
                }

                if (!string.IsNullOrWhiteSpace(weekWorkLoad))
                {
                    JObject jObject = JObject.Parse(todayWorkLoad);
                    reportInfo2.ffzs = jObject["Workload"][0]["ffzs"].ToString();
                    reportInfo2.kkzs = jObject["Workload"][0]["kkzs"].ToString();
                    reportInfo2.fgj = jObject["Workload"][0]["fgj"].ToString();
                    reportInfo2.kgj = jObject["Workload"][0]["kgj"].ToString();
                    reportInfo2.ffcs3 = jObject["Workload"][0]["ffcs3"].ToString();
                    reportInfo2.ffcs4 = jObject["Workload"][0]["ffcs4"].ToString();
                    reportInfo2.ffcs = jObject["Workload"][0]["ffcs"].ToString();
                    reportInfo2.ffcs2 = jObject["Workload"][0]["ffcs2"].ToString();
                }

                if (!string.IsNullOrWhiteSpace(weekWorkLoadRank))
                {
                    JObject jObject = JObject.Parse(todayWorkLoadRank);
                    reportInfo2.companyRank2 = jObject["WorkloadRank"][0]["RowNum"].ToString();
                }

                if (!string.IsNullOrWhiteSpace(monthAchievement))
                {
                    JObject jObject = JObject.Parse(todayAchievement);
                    reportInfo3.receivableNum = jObject["Achievement"][0]["ys"].ToString();
                    reportInfo3.paidNum = jObject["Achievement"][0]["ss"].ToString();
                    reportInfo3.nrNum = (double.Parse(reportInfo3.receivableNum) - double.Parse(reportInfo3.paidNum)).ToString();
                    reportInfo3.companyRank = jObject["Achievement"][0]["rk"].ToString();
                }

                if (!string.IsNullOrWhiteSpace(monthWorkLoad))
                {
                    JObject jObject = JObject.Parse(todayWorkLoad);
                    reportInfo3.ffzs = jObject["Workload"][0]["ffzs"].ToString();
                    reportInfo3.kkzs = jObject["Workload"][0]["kkzs"].ToString();
                    reportInfo3.fgj = jObject["Workload"][0]["fgj"].ToString();
                    reportInfo3.kgj = jObject["Workload"][0]["kgj"].ToString();
                    reportInfo3.ffcs3 = jObject["Workload"][0]["ffcs3"].ToString();
                    reportInfo3.ffcs4 = jObject["Workload"][0]["ffcs4"].ToString();
                    reportInfo3.ffcs = jObject["Workload"][0]["ffcs"].ToString();
                    reportInfo3.ffcs2 = jObject["Workload"][0]["ffcs2"].ToString();
                }

                if (!string.IsNullOrWhiteSpace(monthWorkLoadRank))
                {
                    JObject jObject = JObject.Parse(todayWorkLoadRank);
                    reportInfo3.companyRank2 = jObject["WorkloadRank"][0]["RowNum"].ToString();
                }
